...
\subsection{Utiliser l'API de la plate-forme}
    ...
    \lstinputlisting[caption={Exemple d'extension utilisant la plate-forme}, language=Java, captionpos=b,keywordstyle=\color{blue},stringstyle=\color{red},]{data/exemple-extension.java}
